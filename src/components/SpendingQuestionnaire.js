...
class SpendingQuestionnaire extends React.Component {
  ...
  handleSubmit = values => {
    const {
      updateUserSpendingFood,
      updateUserSpendingAlcohol,
      updateUserSpendingClothing,
      updateUserSpendingEducation,
      updateUserSpendingHousehold,
      updateUserSpendingOther,
      updateUserSpendingRecreation,
      updateUserSpendingTransport,
      updateUserSpendingResturants
    } = this.props;
...
const mapDispatchToProps = dispatch => {
  return {
    updateUserSpendingFood: spending =>
      dispatch(updateUserSpendingFood(spending)),
    updateUserSpendingClothing: spending =>
      dispatch(updateUserSpendingClothing(spending)),
    updateUserSpendingEducation: spending =>
      dispatch(updateUserSpendingEducation(spending)),
    updateUserSpendingAlcohol: spending =>
      dispatch(updateUserSpendingAlcohol(spending)),
    updateUserSpendingHousehold: spending =>
      dispatch(updateUserSpendingHousehold(spending)),
    updateUserSpendingOther: spending =>
      dispatch(updateUserSpendingOther(spending)),
    updateUserSpendingRecreation: spending =>
      dispatch(updateUserSpendingRecreation(spending)),
    updateUserSpendingTransport: spending =>
      dispatch(updateUserSpendingTransport(spending)),
    updateUserSpendingResturants: spending =>
      dispatch(updateUserSpendingResturants(spending)),
